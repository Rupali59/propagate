...
const RECONCILE_LIB = fileURLToPath(new URL("../lib/reconcile.mjs", import.meta.url));
const EVENTS_LIB = fileURLToPath(new URL("../lib/events.mjs", import.meta.url));
const CONTENT_ID_LIB = fileURLToPath(new URL("../lib/content-id.mjs", import.meta.url));
