...
import { buildWorkspaceSnapshot, diffSnapshots, refsDir, WORKSPACE_SNAPSHOT_SCHEMA, LIFECYCLE_SCHEMA, SNAPSHOT_BLIND_SPOT } from "./snapshot.mjs";
...
export function convertV1(v1) {
  ...
  return {
    ...
    // The converted snapshot inherits the SAME limitation — v1 was produced by
    // the very tool the sentence was written for. Declaring it only on fresh
    // captures would make a migrated workspace look like it had none.
    blind_spot: v1?.blind_spot ?? SNAPSHOT_BLIND_SPOT,
