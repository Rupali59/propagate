...
export const EXPECTATIONS = [
  ...
  },
  {
    ...
    describe: "docs.supersession_prose_only <= 105 (ratchet: must not grow)",
    ...
    assert: (m) => (m["docs.supersession_prose_only"] ?? 0) <= 105,
    basis:
      "Measured 2026-08-18: 105 docs say `supersede` in prose with no `supersedes:` " +
    ...
    detail: (m) => {
      ...
      return n <= 105 ? `${n} prose-only (baseline 105)` : `${n} — GREW past the 105 baseline`;
    },
  },
  {
