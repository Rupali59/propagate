...
export const EXPECTATIONS = [
  ...
  },
  {
    ...
    describe: "docs.supersession_prose_only <= 103 (ratchet: must not grow)",
    ...
    assert: (m) => (m["docs.supersession_prose_only"] ?? 0) <= 103,
    basis:
      "Measured 2026-08-19: 103 docs say `supersede` in prose with no `supersedes:` " +
    ...
    detail: (m) => {
      ...
      return n <= 103 ? `${n} prose-only (baseline 103)` : `${n} — GREW past the 103 baseline`;
    },
  },
  {
