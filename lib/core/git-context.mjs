...
/**
 * Resolve the sidecar path for a ledger's git-backfill entries, using the
 * same docs/-vs-.propagation/ convention `lib/discovery.mjs` uses for the
 * ledger itself: `<root>/docs/PROPAGATION_LEDGER.jsonl` → sidecar at
 * `<root>/docs/.propagation/git-backfill.jsonl`; the legacy
 * `<root>/.propagation/ledger.jsonl` → sidecar at
