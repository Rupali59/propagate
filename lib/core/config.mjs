 ...
 */
const CROSS_LEDGER_ROOT_JSONL = path.join(SEARCH_ROOTS[0], "PROPAGATION_CROSS_LEDGER.jsonl");
const CROSS_LEDGER_ROOT_MD = path.join(SEARCH_ROOTS[0], "PROPAGATION_CROSS_LEDGER.md");
const CROSS_LEDGER_PROPAGATION_JSONL = path.join(SEARCH_ROOTS[0], "propagation", "PROPAGATION_CROSS_LEDGER.jsonl");
const CROSS_LEDGER_PROPAGATION_MD = path.join(SEARCH_ROOTS[0], "propagation", "PROPAGATION_CROSS_LEDGER.md");
const crossLedgerRelocated = existsSync(CROSS_LEDGER_PROPAGATION_JSONL);
