...
export const MARKETPLACE_DIR = path.join(HOME, "Documents", "GitHub", "skills-marketplace");
...
export const LIFECYCLE_LOG = path.join(HOME, ".claude", "skills", "propagate", "SKILLS_LIFECYCLE.jsonl");
