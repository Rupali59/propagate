 ...
 * refuses wholesale. Here the document is AUTHORED — a workspace constitution doc is 420 lines of
 * authored prose — and only the marker lines are ours. So the contract is
 ...
 * person wrote, and which they alone can read. The repo
