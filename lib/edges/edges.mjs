 ...
 *
 * Moved here from cli.mjs 2026-08-25 (#31 T2): doctor's extracted per-workspace
 * section calls it, and importing it from cli.mjs would be a cycle. It is edge
 * semantics, so this is its right home regardless. cli.mjs re-exports it for
 * tests/unit/downstream-path-guard.test.mjs.
 *
