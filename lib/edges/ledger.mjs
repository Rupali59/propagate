...
// ─── moved from cli.mjs 2026-08-25 (#31 T5) ───
// Pure helpers over a ledger row and its age. Shared by the `drain` and `status`
// command families, so they belong here rather than in either one — and they
// return data and print nothing, which is what lib/ modules do.
