...
const TABLES = ["ledger_row", "ledger_unknown", "decision", "decision_affects", "state_doc", "source_file", "coverage_gap"];
 ...
 */
export function rebuildIndex({ dbPath, roots, skillDir, discover = discoverWorkspacesSync }) {
  const t0 = Date.now();
