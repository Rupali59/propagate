...
export function checkRules({ rulesDir, roots, exclude = [], maxDepth = 6, extra = [] } = {}) {
  ...
  const { files, missing } = findCandidateFiles(roots, { maxDepth, extra });

  const base = { rules, filesScanned: files.length, findings: [], overrides: [], missing };
