...
export const KINDS = {
  ...
  gotchas: "hazards and their triggers; can be current and still INERT if a trigger cannot fire",
  ...
  issues: "a register of numbered entries with statuses; rots by reporting closed work as open",
};
