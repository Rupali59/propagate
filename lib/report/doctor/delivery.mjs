...
import { CLAUDE_PLUGIN_CACHE, CLAUDE_INSTALLED_PLUGINS } from "../../core/paths.mjs";
 ...
 */
export function servedTrees(cacheRoot = CLAUDE_PLUGIN_CACHE) {
 ...
 */
export function readInstalledPlugins(p = CLAUDE_INSTALLED_PLUGINS) {
  try {
