 ...
 *
 * Counts of open work across registers. A wrong count misleads, and
 * N72/N74/PR-006 record the reader inflating them — but the underlying items
 * stay readable, so the defect is legible rather than hidden.
 *
 *
