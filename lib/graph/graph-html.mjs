...
// Imported, not redeclared. This file held the only definition while
// graph.mjs's worklist sorted by name — one copy in the view, none in the
// model, which is how N89 happened.
import { STATE_SEVERITY } from "./graph.mjs";
...
:root {
  ...
  --clean: #34803a;   --drift: #0c7f7f;   --reverse: #6f63ce; --diverge: #b64797;
...
@media (prefers-color-scheme: dark) {
  :root:not([data-theme="light"]) {
    ...
    --clean: #7fcd82; --drift: #4ecdcd;   --reverse: #b0adfe; --diverge: #fd88d9;
