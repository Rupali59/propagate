...
import { CLAUDE_GOTCHAS_GLOBAL, CLAUDE_GOTCHA_GUARD_LOG } from "../core/paths.mjs";
 ...
 *
 * The registry default (lib/core/paths.mjs) is the FALLBACK, not a
 * replacement — GOTCHA_GUARD_GLOBAL/GOTCHA_GUARD_LOG still win when set, same
 * precedence as before the migration.
 */
export const GLOBAL_INDEX = process.env.GOTCHA_GUARD_GLOBAL || CLAUDE_GOTCHAS_GLOBAL;
export const LOG = process.env.GOTCHA_GUARD_LOG || CLAUDE_GOTCHA_GUARD_LOG;
